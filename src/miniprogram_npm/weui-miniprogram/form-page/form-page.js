  ...
  render() {
    ...
    return (
      <View className="weui-form">
        {title || subtitle ? (
          <Block>
            <View className="weui-form__text-area">
              <View className="weui-form__title">{title}</View>
              <View className="weui-form__desc">{subtitle}</View>
            </View>
          </Block>
        ) : (
          <Block>
        ...
        <View className="weui-form__tips-area">{this.props.renderTips}</View>
        <View className="weui-form__opr-area">{this.props.renderButton}</View>
        <View className="weui-form__tips-area">
          {this.props.renderSuffixtips}
        </View>
